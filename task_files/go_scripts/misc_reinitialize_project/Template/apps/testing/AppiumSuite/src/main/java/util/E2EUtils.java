...
public class E2EUtils {
  ...
  public E2EUtils click(WebDriver driver, By selector) {
    return click(driver, selector, Duration.ofSeconds(0));
  }

  public E2EUtils click(WebDriver driver, By selector, Duration waitTime) {
  ...
  public WebElement getElement(WebDriver driver, By selector){
    return getElement( driver, selector,  Duration.ofSeconds(0));
  }

  public WebElement getElement(WebDriver driver, By selector, Duration waitTime){
    WebDriverWait wait = new WebDriverWait(driver, waitTime);
    wait.until(ExpectedConditions.elementToBeClickable(selector));
  ...
  public List<WebElement> getElements(WebDriver driver, By selector){
    return getElements( driver, selector,  Duration.ofSeconds(0));
  }

  public List<WebElement> getElements(WebDriver driver, By selector, Duration waitTime){
    WebDriverWait wait = new WebDriverWait(driver, waitTime);
    wait.until(ExpectedConditions.elementToBeClickable(selector));
  ...
  public E2EUtils clickFromOptions(
    ...
    return clickFromOptions(driver, selector, null, Duration.ofSeconds(0));
  }
  ...
  public E2EUtils clickFromOptions(
    ...
    return clickFromOptions(driver, selector, optionIndex, Duration.ofSeconds(0));
  }
